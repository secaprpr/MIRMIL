...
from utils.loop_utils import ot_train_loop, ot_val_loop
...
from utils.process_utils import build_train_dataloader, get_process_pipeline
...
def process_OT_MIL(args):
    ...
    train_dataloader = build_train_dataloader(args, train_dataset, generator)
    ...
    best_epoch = 1
    warmup_epochs = args.Model.scheduler.warmup
    ...
    for epoch in tqdm(range(args.General.num_epochs), colour="GREEN"):
        ...
        print(
            ...
            f"Test_Loss:{test_loss}, Cost_Time:{cost_time}"
        )

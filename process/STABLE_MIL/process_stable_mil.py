...
from utils.wsi_utils import WSI_Coord_Dataset


def process_STABLE_MIL(args):
    train_dataset = WSI_Coord_Dataset(args.Dataset.dataset_csv_path, 'train')
    val_dataset = WSI_Coord_Dataset(args.Dataset.dataset_csv_path, 'val')
    test_dataset = WSI_Coord_Dataset(args.Dataset.dataset_csv_path, 'test')

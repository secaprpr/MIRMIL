...
run_candidate() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu" WANDB_MODE=disabled "$PY" \
    ...
    --in-dim 1024 \
    --feature uni \
    --protocol bracs3-v3-uni-final-narrow-val-only \
    --split-id official-train-val-3class \
    --comparison-id "bracs3-uni-$variant-final-narrow" \
    --device 0 \
    --num-workers 2 \
    --wandb-mode disabled \
    --balanced \
...
run_pair 0 MIR_MIL_V3_FINAL_GAP125 &
run_pair 2 MIR_MIL_V3_FINAL_GAP135 &
run_pair 3 MIR_MIL_V3_FINAL_GAP165 &
run_pair 4 MIR_MIL_V3_FINAL_GAP175 &
run_pair 5 MIR_MIL_V3_FINAL_GAP15_DT045 &
run_candidate 6 MIR_MIL_V3_FINAL_GAP15_DT055 2024 &
run_candidate 7 MIR_MIL_V3_FINAL_GAP15_DT055 2025 &

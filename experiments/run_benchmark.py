...
MODEL_SPECS = {
    "MIR_MIL_V3_FINAL_GAP125": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            "Model.risk_aggregation=entropic",
            "Model.risk_prediction_head=ordinal",
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.25",
        ],
    },
    "MIR_MIL_V3_FINAL_GAP135": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.35",
        ],
    },
    "MIR_MIL_V3_FINAL_GAP165": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.65",
        ],
    },
    "MIR_MIL_V3_FINAL_GAP175": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.75",
        ],
    },
    "MIR_MIL_V3_FINAL_GAP15_DT045": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_prediction_head=ordinal",
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.45",
            "Model.initial_threshold_gap=1.5",
        ],
    },
    "MIR_MIL_V3_FINAL_GAP15_DT055": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_prediction_head=ordinal",
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.55",
            "Model.initial_threshold_gap=1.5",
        ],
    },
    "MIR_MIL_V3_HPO_BASE_HMEAN": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.0",
        ],
    },
    "MIR_MIL_V3_HPO_GAP15": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
    ...
    "MIR_MIL_V3_HPO_GAP20": {
        ...
        "options": [
            ...
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=2.0",
        ],
    },
    "MIR_MIL_V3_HPO_DT035": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            ...
            "Model.risk_prediction_head=ordinal",
            "Model.risk_temperature=0.5",
            "Model.risk_decision_temperature=0.35",
            "Model.initial_threshold_gap=1.0",
        ],
    },
    "MIR_MIL_V3_HPO_RT025": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            "Model.risk_aggregation=entropic",
            "Model.risk_prediction_head=ordinal",
            "Model.risk_temperature=0.25",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.0",
        ],
    },
    "MIR_MIL_V3_HPO_RT100": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
            "Model.risk_aggregation=entropic",
            "Model.risk_prediction_head=ordinal",
            "Model.risk_temperature=1.0",
            "Model.risk_decision_temperature=0.5",
            "Model.initial_threshold_gap=1.0",
        ],
    },
    "MIR_MIL_V3_HPO_GAP15_RT025": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=ordinal_risk",
    ...
    "MIR_MIL_V4_MEAN_BOUNDARY": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=boundary_risk",
            "Model.risk_aggregation=mean",
        ],
    },
    "MIR_MIL_V4_RISK_BOUNDARY": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.prediction_mode=boundary_risk",
    ...
    "MIR_MIL_V3_RISK_SOFTMAX": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.risk_aggregation=entropic",
            "Model.risk_prediction_head=softmax",
        ],
    },
    "MIR_MIL_V3_RISK_ORDINAL": {
        "config": "configs/MIR_MIL_V3.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.risk_aggregation=entropic",
    ...
    "MIR_MIL_V21": {
        ...
        "model": "MIR_MIL",
        "options": [
            "Model.pairwise_boundary_weight=0.0",
            "Model.pairwise_boundary_loss_weight=0.05",
            "Model.pairwise_boundary_alignment_weight=0.05",
            "Model.pairwise_boundary_query_dim=64",
            "Model.pairwise_boundary_value_dim=128",
            "Model.pairwise_boundary_rank_dim=64",
            "Model.pairwise_boundary_temperature=1.0",
            "Model.pairwise_boundary_dropout=0.0",
        ],
    },
    "MIR_MIL_V2": {
        "config": "configs/releases/MIR_MIL_MT_V1.yaml",
        "model": "MIR_MIL",
        "options": [
            "Model.pairwise_boundary_weight=0.1",
            "Model.pairwise_boundary_loss_weight=0.1",
            "Model.pairwise_boundary_query_dim=64",
            "Model.pairwise_boundary_value_dim=128",
            "Model.pairwise_boundary_rank_dim=64",
            "Model.pairwise_boundary_temperature=1.0",
